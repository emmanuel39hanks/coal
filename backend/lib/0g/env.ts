...
export const zeroGEnv = {
    ...
    storageKvRpcUrl: readEnv('ZERO_G_STORAGE_KV_RPC_URL') || 'http://mainnet-kv.0g.ai:6789',
    storageFlowAddress: readEnv('ZERO_G_STORAGE_FLOW_ADDRESS') || '0x62D4144dB0F0a6fBBaeb6296c785C71B3D57C526',

...
- [demo-store](https://coal-demo-store.vercel.app) — Full storefront with agent manifests + catalog indexing ([source](https://github.com/emmanuel39hanks/coal/tree/main/examples/demo-store))

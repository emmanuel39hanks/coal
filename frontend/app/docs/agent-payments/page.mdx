...
The [coal-agent](https://agent.usecoal.xyz) example app exposes these OpenAI function-calling tools:
...
Try the [Coal Agent Demo](https://agent.usecoal.xyz) — click "Buy me something under $1" or "Get me ETH price from the oracle" to see autonomous payments in action.
